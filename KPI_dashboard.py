...
st.markdown("Exploring demand, performance, risk, and feasibility across game genres.")
...
try:
    ...
    st.error("Could not find 'video_games_sales.csv'. Please ensure the file is in the same directory.")
    st.stop()

# ---------------------------------------------------------
# 3. KPI LOGIC (From your analysis script)
# ---------------------------------------------------------
